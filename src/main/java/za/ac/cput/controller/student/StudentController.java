...
public class StudentController
{
    ...
    public ResponseEntity<List<String>> readStudentSurnameByCountryId(@PathVariable String countryId)
    {
        List<String> allSurname = this.studentService.getStudentSurnameByCountryId(countryId);
